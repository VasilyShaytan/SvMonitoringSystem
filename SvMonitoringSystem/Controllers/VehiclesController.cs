...
namespace SvMonitoringSystem.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VehicleId,Mark,ModelType,СarryingСapacity,YearIssue,UsefulVolume,VehicleType,OverallDimensions")] Vehicle vehicle)
        {
